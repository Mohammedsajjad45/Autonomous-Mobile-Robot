...
int main(int argc, char** argv){
  ...
  while(run) {
	...
	goal.target_pose.pose.position.y = -3.01;
	...
	goal.target_pose.pose.position.y = 0.03;
        goal.target_pose.pose.orientation.w = 3.13;
        break;
      case 3:
        cout << "\nGoal Location: C\n" << endl;
        goal.target_pose.pose.position.x = 1.96;
	goal.target_pose.pose.position.y = 0.04;
        goal.target_pose.pose.orientation.w = -0.014;
        break;
	case 4:
        cout << "\nGoal Location: D\n" << endl;  //EXTRA
        goal.target_pose.pose.position.x = -0.22;
	goal.target_pose.pose.position.y = -3.39;
        goal.target_pose.pose.orientation.w = 0.007;
        break;

	/*case 1:
        cout << "\nGoal Location: Bathroom\n" << endl; //TURTLE_BOT NAVIGATION
	...
	goal.target_pose.pose.position.y = 2.02;
      ...
      case 3:
        ...
        goal.target_pose.pose.position.x = -0.03;
