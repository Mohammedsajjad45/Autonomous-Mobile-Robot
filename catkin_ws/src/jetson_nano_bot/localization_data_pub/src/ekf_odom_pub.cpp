...
const double TICKS_PER_REVOLUTION = 47; // For reference purposes.
const double WHEEL_RADIUS = 0.081; // Wheel radius in meters
const double WHEEL_BASE = 0.279; // Center of left tire to center of right tire
const double TICKS_PER_METER = 97; // Original was 2800
...
// Update odometry informationouble cycleAngle = asin((distanceRight-distanceLeft)/WHEEL_B
void update_odom() {
